...
SELECT AId
  , printf(" %.2f%% ", Zinssatz/100.) AS Zinssatz
  , Zeitraum
  , Bezeichnung
...
UNION ALL
  SELECT * FROM AnlagenOhneVertraege
UNION ALL
  SELECT * FROM fortlVertraege_inaktiv
UNION ALL
  SELECT * FROM begrenzteVertraege_aktiv
UNION ALL
  SELECT * FROM fortlVertraege_aktiv
UNION ALL
