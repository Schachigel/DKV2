...
*/
bool copy_database( const QString& targetFileName, const QSqlDatabase& sourceDb =QSqlDatabase::database());
...
*/
bool copy_database_anonymous( const QString& targetFileName, const QSqlDatabase& sourceDb =QSqlDatabase::database());
...
*/
bool convert_database_inplace( const QString& targetFilename, const QString& tempFileName =QString());
